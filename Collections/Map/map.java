...
public class map {
  public static void main(String[] args) {
    ...
    */
    ...
    /*      Formas de inicializar um map/dicionário
    ...
    */
    ...
    Map<String, Double> carrosPopulares = new HashMap<>() {{
      // As chaves têm valor único, já os valores podem ser repetidos
      put("gol", 14.4);
      put("uno", 15.6);
      put("mobi", 16.1);
      put("hb20", 14.5);
    ...
    System.out.println("Não é possível, pois estamos lidando com hash \n\n");

    System.out.println("Exiba os modelos: ");
    // Não tenho como fazer isso no map.. tenho que fazer um set
    Set<String> modelos = carrosPopulares.keySet();
    System.out.println(modelos+"\n\n");

    System.out.println("Exiba os consumos dos carros: ");
    // Tb não tenho essa opção no map.. preciso usar collections
    Collection<Double> consumos = carrosPopulares.values();
    System.out.println(consumos + "\n\n");

    System.out.println("Exiba o modelo mais econômico e seu consumo: ");
    Double consumoMaisEficiente = Collections.max(carrosPopulares.values());  // Busco o maior consumo
